...
set_error_handler(function($errno, $errstr, $errfile, $errline) {
    respondAttendanceApiFailure('Attendance masuk PHP error', new ErrorException($errstr, 0, $errno, $errfile, $errline));
});

set_exception_handler(function($e) {
    respondAttendanceApiFailure('Attendance masuk exception', $e);
});
...
try {
    ...
    if (!function_exists('processAttendanceMasuk')) {
        throw new Exception('Function processAttendanceMasuk tidak ditemukan');
    }
    ...
    $response = processAttendanceMasuk($conn, $kode, $tipe);
    ...
    respondAttendanceApiFailure('Attendance masuk catch block', $e);
}