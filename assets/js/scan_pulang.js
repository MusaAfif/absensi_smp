/* ===== SCAN ABSEN PULANG - JAVASCRIPT ===== */

$(document).ready(function() {
    const BASE_PATH = window.BASE_PATH || '';
    // Dedicated endpoint for absen pulang
    const SCAN_ENDPOINT = '/' + BASE_PATH.replace(/^\/+|\/+$/g, '') + (BASE_PATH ? '/' : '') + 'api/attendance/pulang.php';
    const OFFLINE_QUEUE_KEY = 'absensi_pulang_offline_queue';
    ...
    async function handleScan() {
        ...
        // pulang.php expects 'kode' field
        const payload = { kode: value, tipe: 'barcode' };
    ...
    function showScanState(state, data) {
        ...
        switch(state) {
                ...
                html = `
                    <div class="last-scan-card processing">
                        <div class="empty-state">
                            <i class="fas fa-spinner fa-spin" style="color: #3b82f6; font-size: 3rem;"></i>
                            <p style="font-weight: 500; margin-bottom: 4px; color: #3b82f6;">Memproses scan pulang...</p>
            ...
            case 'success':
                const phase = data.scan_phase || 'Pulang';
                ...
                html = `
                    <div class="last-scan-card error-state">
                        <div class="empty-state">
                            ...
                            <p style="font-weight: 500; margin-bottom: 4px; color: #dc2626;">❌ SCAN PULANG GAGAL</p>
