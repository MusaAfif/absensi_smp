...
<head>
    ...
    <title>SCAN ABSEN MASUK | <?= $nama_sekolah ?></title>
    ...
    <style>
        ...
        .scan-header { background: linear-gradient(135deg, var(--primary-green), var(--primary-green-dark)); }
        .scanner-section { border-left: 4px solid var(--primary-green); }
        .stat-card.masuk { background: linear-gradient(135deg, var(--primary-green-light), #a7f3d0); border-color: var(--primary-green); }
        .stat-card.masuk .stat-number { color: var(--primary-green-dark); }
        .control-btn.active { background-color: var(--primary-green); border-color: var(--primary-green); }
        .control-btn.active:hover { background-color: var(--primary-green-dark); }
...
<div class="scan-header">
    <div class="header-top">
        <div class="header-info">
            <h3><i class="fas fa-sign-in-alt me-2"></i>SCAN ABSEN MASUK</h3>
            <p><?= $nama_sekolah ?></p>
        </div>
    ...
    <div class="header-nav">
        ...
        <a href="scan_pulang.php" class="btn btn-outline-light" title="Halaman Absen Pulang">
        ...
        <div class="barcode-input-section">
            <div class="input-group">
                ...
                <button class="btn btn-primary" id="btn-proses">
                    <i class="fas fa-check me-1"></i> SCAN MASUK
                </button>
            </div>
        </div>
    </div>
...
<script src="../assets/js/scan_masuk.js?v=1.1"></script>
